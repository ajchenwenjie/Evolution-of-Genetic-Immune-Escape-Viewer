                                    ...
                                    h2("Welcome to the Evolution of Genetic Immune Escape Viewer"),
                                     ...
                                     fluidRow(
                                       ...
                                       column(
                                         ...
                                         wellPanel(
                                           style = "height: 500px; display: flex; flex-direction: column; justify-content: space-between;",
                                           h3("Tutorials", style = "text-align: center; margin-top: 0px;"),   # reduced margin
                                           div(
                                     ...
                                     div(
                                       ...
                                       p("The Shiny App is developed by Wenjie Chen. The results are generated by Shengqing Gu lab and Peter Van Loo lab."),
                                       p(
